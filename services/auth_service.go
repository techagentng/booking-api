...
func (a *authService) LoginUser(loginRequest *models.LoginRequest) (*models.LoginResponse, *apiError.Error) {
	...
	return a.generateLoginResponse(foundUser, role)
}
...
func (a *authService) createGoogleUser(loginRequest *models.GoogleLoginRequest) (*models.LoginResponse, *apiError.Error) {
	...
	// Generate login response with tokens
	return a.generateLoginResponse(createdUser, role)
}
...
// generateLoginResponse creates a LoginResponse from a user and role
func (a *authService) generateLoginResponse(user *models.User, role *models.Role) (*models.LoginResponse, *apiError.Error) {
	...
	if err != nil {
		log.Printf("generateLoginResponse: error generating tokens: %v", err)
